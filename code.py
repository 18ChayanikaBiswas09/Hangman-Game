...
root = Tk()
root.title("HangMan")
root.iconbitmap("C:\\Users\\DELL\\Desktop\\logo\\ico.ico")
...
def play_music():
    ...
    if music_state:
        ...
        pygame.mixer.music.load("C:\\Users\\DELL\\Desktop\\logo\\music1.mp3")
...
def main_menu_():
    ...
    main_menu_bg = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\main.jpg").resize((800, 450), Image.ANTIALIAS))
    ...
    canvas.create_window(400, 210, anchor=CENTER, window=quit_btn)
...
def new_game():
    ...
    new_game_window.iconbitmap("C:\\Users\\DELL\\Desktop\\logo\\ico.ico")
    ...
    new_game_bg = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\main.jpg").resize((800, 450), Image.ANTIALIAS))
    ...
    anime_btn = Checkbutton(new_game_window, text="Animals", variable=var1, onvalue="a", offvalue="")
    ...
    tv_btn = Checkbutton(new_game_window, text="Birds", variable=var4, onvalue="t", offvalue="")
...
def prepare(choice):
    ...
    movies = open("C:\\Users\\DELL\\Desktop\\movie.txt", "r")  # Open word files
    games = open("C:\\Users\\DELL\\Desktop\\game.txt", "r")
    tv = open("C:\\Users\\DELL\\Desktop\\birds.txt", "r")
    anime = open("C:\\Users\\DELL\\Desktop\\animal.txt", "r")
    categories = ""
...
def assistance():
    ...
    if word_change == 0 and letter_change == 0:
        ...
        option_window.iconbitmap("C:\\Users\\DELL\\Desktop\\logo\\ico.ico")
...
def my_answer():
    ...
    if e.get()[0:1] in chars_bank:
        ...
        if e.get()[0:1].upper() in str(answer).upper():  # upper in order to ignore if the letter is written
            ...
            guesses -= 1
            if guesses == 4:
                play_bg4 = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\zero.jpg").resize((800, 450), Image.ANTIALIAS))
                canvas_play.background = play_bg4
                canvas_play.create_image(0, 0, anchor=NW, image=play_bg4)
            if guesses == 3:
                play_bg3 = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\one.jpg").resize((800, 450), Image.ANTIALIAS))
                canvas_play.background = play_bg3
                canvas_play.create_image(0, 0, anchor=NW, image=play_bg3)
            if guesses == 2:
                play_bg2 = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\two.jpg").resize((800, 450), Image.ANTIALIAS))
                canvas_play.background = play_bg2
                canvas_play.create_image(0, 0, anchor=NW, image=play_bg2)
            if guesses == 1:
                play_bg1 = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\three.jpg").resize((800, 450), Image.ANTIALIAS))
                canvas_play.background = play_bg1
                canvas_play.create_image(0, 0, anchor=NW, image=play_bg1)
            if guesses == 0:
                play_bg0 = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\four.jpg").resize((800, 450), Image.ANTIALIAS))
...
def play(hidden, word, count):
    ...
    play_window.iconbitmap("C:\\Users\\DELL\\Desktop\\logo\\ico.ico")
    ...
    play_bg = ImageTk.PhotoImage(Image.open("C:\\Users\\DELL\\Desktop\\logo\\main.jpg").resize((800, 450), Image.ANTIALIAS))
